...
```{r}
otu_counts_table <- read.table("/home/renato/projects/fapesp_bepe_pd/microbiome/2f_otu_table.sample_filtered.no_mitochondria_chloroplast.tsv",
...
aitchison_day_period_plot <- ggplot(data = aitchison_pcoa_df, 
                                        aes(x=pcoa1, y=pcoa2,
                                            color = sample_group)) +
  geom_point() +
  labs(x = "PC1",
